package com.einstein.playlist.config;
...
@EnableJpaRepositories(basePackages = "com.einstein.playlist.repository")
public class PersistenceConfig {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setSchema(env.getProperty("dataSource.schema"));
        return dataSource;
    }
